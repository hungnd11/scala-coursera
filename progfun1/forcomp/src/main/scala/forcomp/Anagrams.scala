...
object Anagrams {
  ...
  def wordOccurrences(w: Word): Occurrences = 
    ((w.toLowerCase groupBy (e => e)) map (e => (e._1, e._2.length))).toList sortWith (_._1 < _._1)
  ...
  def subtract(x: Occurrences, y: Occurrences): Occurrences = {
    def adjust(acc: List[(Char, Int)], b: (Char, Int)) = {
      y.filter(_._1 == b._1) match {
        case List() => acc :+ b
        case (_, b._2) :: xs => acc
        case h :: xs => acc :+ (h._1, b._2 - h._2)
      }
    }

    x.foldLeft(List[(Char, Int)]())(adjust)
  }
